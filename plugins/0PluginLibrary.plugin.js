...
class WebpackModules {
    ...
    static get require() {
        ...
        const __nested_webpack_require_10821__ = window.webpackJsonp.push([[], {
            [id]: (module, exports, req) => module.exports = req
        }, [[id]]]);
        delete __nested_webpack_require_10821__.m[id];
        delete __nested_webpack_require_10821__.c[id];
        return this._require = __nested_webpack_require_10821__;
    }
...
class Popouts {
    ...
    static showUserPopout(target, user, options = {}) {
        const {guild = modules__WEBPACK_IMPORTED_MODULE_0__.DiscordModules.SelectedGuildStore.getGuildId(), channel = modules__WEBPACK_IMPORTED_MODULE_0__.DiscordModules.SelectedChannelStore.getChannelId()} = options;
        let {position = "right", align = "top"} = options;
        target = modules__WEBPACK_IMPORTED_MODULE_0__.DOMTools.resolveElement(target);
        if (target.getBoundingClientRect().right + 250 >= modules__WEBPACK_IMPORTED_MODULE_0__.DOMTools.screenWidth) position = "left";
        if (target.getBoundingClientRect().bottom + 400 >= modules__WEBPACK_IMPORTED_MODULE_0__.DOMTools.screenHeight) align = "bottom";
        if (target.getBoundingClientRect().top - 400 >= modules__WEBPACK_IMPORTED_MODULE_0__.DOMTools.screenHeight) align = "top";
